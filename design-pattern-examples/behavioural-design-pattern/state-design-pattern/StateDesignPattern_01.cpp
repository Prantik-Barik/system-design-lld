//state ka abstract class banao with virtual functions that will change the state
//context/object ko state change kre wo class banao with all the funtions
// concrete state classes banao with overruding the functions of state change
